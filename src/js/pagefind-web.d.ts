// https://github.com/CloudCannon/pagefind/issues/767

declare module "pagefind-web" {
  ...
  export declare const options: (new_options: PagefindIndexOptions) => Promise<void>;
  export declare const init: () => Promise<void>;
  export declare const destroy: () => Promise<void>;
  export declare const mergeIndex: (indexPath: string, options?: PagefindIndexOptions) => Promise<void>;
  export declare const search: (term: string, options?: PagefindSearchOptions) => Promise<PagefindIndexesSearchResults>;
  export declare const debouncedSearch: (term: string, options?: PagefindSearchOptions, debounceTimeoutMs?: number) => Promise<PagefindIndexesSearchResults | null>;
  export declare const preload: (term: string, options?: PagefindSearchOptions) => Promise<void>;
